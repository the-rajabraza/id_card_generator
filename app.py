...
def generate_id_card(name, roll_no, distance_learning, city, center, campus, days_time, batch, user_image_path, logo_image_path, output_file):
    ...
    # Load or define the fonts (update path to font files on your system)
    font_path_large = "arialbd.ttf"  # Bold font for title and headings
    font_path_medium = "arial.ttf"  # Regular font for details
    font_path_small = "arial.ttf"  # Small text font
    ...
    font_large = ImageFont.truetype(font_path_large, 40)  # For 'ID CARD' text
    font_medium = ImageFont.truetype(font_path_medium, 30)  # For details
    font_small = ImageFont.truetype(font_path_small, 25)  # For smaller details
